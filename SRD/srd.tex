...
\section{Besoins du système}
	...
	\subsection{Design et fonctionnement du système}
		...
		\begin{center}\includegraphics[scale=0.5]{Server.png}\end{center}
			...
			Le client ne possedera aucune information, il est obligé de passer par les serveur quel que soit son intention.
		...
		\begin{center}\includegraphics[scale=0.5]{Game.png}\end{center}
			...
			Pour qu'une partie puisse avoir lieu, il nous faut 2 joueurs connectés au serveur qui sera chargé de réguler le bon fonctionnement de la partie.

...
\section{Introduction}
    \subsection{But du projet}
        ...
        \subsubsection{Description du Wizard Poker}
            ...
            peut éventuellement être réutilisée à l'aide de sorts particuliers par exemple. Une carte défaussée n'est pas perdue, elle reste :
...
\section{Besoins de l'utilisateur}
    ...
    \subsection{Exigences fonctionnelles}
        ...
        \subsubsection{Début de partie}
            \begin{center}\includegraphics[scale=0.35]{Collaboration2_StartDuel.png}\end{center}

...
\title{Software Requirement Document : Wizard Poker \\ Groupe 2}
...
\section{Introduction}
	\subsection{But du projet}
		...
		un jeu de carte (appelé \textit{Wizard Poker}) au tour par tour et multijoueurs en réseau. Elle est destinée à tous types de public, \textit{open source},
		libre de droit et à but non commercial. C'est un projet académique.  % licence à définir. % REFORMULER: on dirait que c'est le public qui est open-source

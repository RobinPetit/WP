...
\newglossaryentry{lobby}{
    type=glossary,
    name={lobby},
    description={Dans le domaine du jeu vidéo, un \textit{lobby} (désignant un "salon" ou un "hall" en français) désigne un menu où se réunissent les joueurs pour pouvoir jouer ensemble.},
    sort=120
}
\newglossaryentry{ladder}{
    type=glossary,
    name={ladder},
    description={Dans le domaine du jeu vidéo, un \textit{ladder} (désignant une "échelle" en français) désigne un certain classements des joueurs, le premier étant tout en haut du \textit{ladder}.},
    sort=130
}

...
\newglossaryentry{GUI}{
    type=glossary,
    name={GUI},
    description={En informatique, GUI (ou encore graphical user interface) désigne une interface graphique permmettant à l'utilisateur d'interagir avec le programme voulu.},
    sort=110
}

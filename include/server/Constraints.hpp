...
constexpr ConstraintDefaultValue C_CONSTRAINT_DEFAULTS[C_CONSTRAINTS_COUNT] =
{
	...
	//passive
	{0,VALUE_GET_DECREMENT,GET_FIRST},	//CC_TEMP_FORCE_ATTACKS
	{0,VALUE_GET_DECREMENT,GET_FIRST},	//CC_TEMP_BLOCK_ATTACKS
	{0,VALUE_GET_DECREMENT,GET_FIRST},	//CC_TEMP_MIRROR_ATTACKS
	{0,VALUE_GET_DECREMENT,GET_FIRST},	//CC_TEMP_BACKFIRE_ATTACKS

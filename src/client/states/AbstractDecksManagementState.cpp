...
{
	addAction("Back to main menu", &AbstractDecksManagementState::backMainMenu);
	addAction("Display a deck", &AbstractDecksManagementState::displayDeck);
	addAction("Edit a deck", &AbstractDecksManagementState::editDeck);
	addAction("Create a deck", &AbstractDecksManagementState::createDeck);
	addAction("Delete a deck", &AbstractDecksManagementState::deleteDeck);
	try
	{
...
void AbstractDecksManagementState::display()
{
...
void AbstractDecksManagementState::displayDeck()
{
	if(_decks.empty())
	{
...
void AbstractDecksManagementState::editDeck()
{
	if(_decks.empty())
	{
...
std::size_t AbstractDecksManagementState::askForReplacedCard(std::size_t deckIndex)
{
	int i{0};
...
cardId AbstractDecksManagementState::askForReplacingCard(std::size_t deckIndex)
{
...
void AbstractDecksManagementState::createDeck()
{
...
void AbstractDecksManagementState::deleteDeck()
{
	if(_decks.empty())
	{

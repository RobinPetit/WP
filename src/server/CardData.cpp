...
const CreatureData ALL_CREATURES[] = {
	...
	},
	{
		...
		{{CREATURE_SELF_THIS,CE_SET_CONSTRAINT,CC_TURN_HEALTH_CHANGE,1,100}},
		"This creature gains 1 HEALTH each turn."
	},
	{
		"Diabolic imp",
		COST_2, ATTACK_3, HEALTH_2, SHIELD_0, SHIELD_NONE,
		{{CREATURE_SELF_THIS,CE_SET_CONSTRAINT,CC_TURN_ATTACK_CHANGE,1,100}},
	...
	},
	{
		...
		{{CREATURE_SELF_THIS,CE_SET_CONSTRAINT,CC_TEMP_BLOCK_ATTACKS,2,100}},
	...
	},
	{
		...
		{{CREATURE_SELF_TEAM,CE_SET_CONSTRAINT,CC_TURN_ATTACK_CHANGE,1,100}},
...
const SpellData ALL_SPELLS[] = {
	...
	},
	{
		"Block",
		COST_9,
		{{CREATURE_SELF_TEAM,CE_SET_CONSTRAINT,CC_TEMP_BLOCK_ATTACKS,3,100}},

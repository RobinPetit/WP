...
const CreatureData ALL_CREATURES[] = {
	...
	},
	{
		...
		{{CREATURE_SELF_THIS,CE_SET_CONSTRAINT,CC_TURN_HEALTH_CHANGE,1,UNLIMITED_TURNS}},
		"This creature gains 1 HEALTH each turn."
	},
	{
		"Diabolic imp",
		COST_2, ATTACK_3, HEALTH_2, SHIELD_0, SHIELD_NONE,
		{{CREATURE_SELF_THIS,CE_SET_CONSTRAINT,CC_TURN_ATTACK_CHANGE,1,UNLIMITED_TURNS}},
	...
	},
	{
		...
		{{PLAYER_OPPO,PE_SET_CONSTRAINT,PC_TURN_HEALTH_CHANGE,-2,UNLIMITED_TURNS}},
		"Each turn, your opponent loses 2 HP."
	},
	{
		"White wizard",
		COST_7, ATTACK_7, HEALTH_7, SHIELD_0, SHIELD_NONE,
		{{CREATURE_SELF_THIS,CE_SET_CONSTRAINT,CC_TEMP_BLOCK_ATTACKS,2,UNLIMITED_TURNS}},
	...
	},
	{
		...
		{{CREATURE_SELF_TEAM,CE_SET_CONSTRAINT,CC_TURN_ATTACK_CHANGE,1,UNLIMITED_TURNS}},
	...
	},
	{
		...
		{{PLAYER_OPPO,PE_SET_CONSTRAINT,PC_TEMP_SPELL_CALL_LIMIT,2,UNLIMITED_TURNS}},
...
const SpellData ALL_SPELLS[] = {
	...
	},
	{
		"Block",
		COST_9,
		{{CREATURE_SELF_TEAM,CE_SET_CONSTRAINT,CC_TEMP_BLOCK_ATTACKS,3,UNLIMITED_TURNS}},
